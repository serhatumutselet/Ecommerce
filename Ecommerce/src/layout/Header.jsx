...
export default function Header() {
  return (
    <header className="flex w-full flex-col">
      <div className="flex h-[58px] w-full items-center bg-[#252B42] text-white">
      ...
      <div className="mx-auto flex w-full max-w-[1439px] flex-col">
        <div className="flex h-[78px] items-center">
          <div className="flex w-full items-center justify-between px-[38px]">
            <div className="flex w-[187px] items-center">
              <button
                type="button"
                className="mr-3 flex h-[24px] w-[24px] items-center justify-center md:hidden"
              >
            ...
            <div className="flex h-[54px] w-[324px] items-center justify-end gap-[10px] text-[#23A6F0]">
              <Link
                to="/"
